...
//
//	mockgen -package=mockrepository -destination ./internal/test/mock/repository/mock_account.go github.com/kidx45/Debter/internal/port/outbound AccountRepository
//
